...
numero_telephone_mobile = Document.create(name: 'Numéro de téléphone mobile', format: 'text')
numero_telephone_fixe = Document.create(name: 'Numéro de téléphone fixe', format: 'text')
...
AccountDocument.new(account: account, document: numero_telephone_mobile)
...
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: numero_contrat_sfr)
AccountDocument.new(account: account, document: numero_telephone_mobile)
...
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: numero_telephone_fixe)
...
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: numero_contrat_sosh)
...
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: numero_contrat_red)

account = Account.create(name: 'Bouygues', subcategory: Subcategory.find_by(name: 'Internet'), status: 'validated')
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: numero_contrat_bouygues)

account = Account.create(name: 'Nordnet', subcategory: Subcategory.find_by(name: 'Internet'), status: 'validated')
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: numero_contrat_nordnet)
...
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: compteur_gaz)
...
AccountDocument.new(account: account, document: acte_deces)
AccountDocument.new(account: account, document: compteur_eau)
